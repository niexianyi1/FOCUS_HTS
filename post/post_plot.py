...
def plot_coil_surface(arge):
    oldcoil_arge = read_hdf5('/home/nxy/codes/coil_spline_HTS/results/w7x/w7x.h5') 
    nzs = int(arge['number_zeta']/arge['number_field_periods']/(arge['stellarator_symmetry']+1)) +1 
    rs = arge['surface_data_r']
    rs = rs[:nzs]
    r_surf = np.zeros((nzs, arge['number_theta']+1, 3))
...
filename = '/home/nxy/codes/coil_spline_HTS/results/hsx/hsx_start/fn4_bf.h5'
...
coilfile = '/home/nxy/codes/coil_spline_HTS/results/hsx/hsx.h5'
...
# filename = '/home/nxy/codes/coil_spline_HTS/initfiles/hsx/coils.hsx'
