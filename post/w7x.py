...
# 优化器
    ...
    'learning_rate_coil':       2e-4,       # (lrc) float,  参数c 迭代步长                     
...
# 线圈
    ...
    # 线圈读取       
    'coil_case':                'spline',  #       str,    线圈表示方法, 'spline' or 'fourier'
    'init_coil_option':         'spline',     #       str,    初始线圈参数的来源, 'spline' or 'coil' or 'fourier'
    'file_type':                'npy',      #       str,    初始线圈文件类型, 'npy' or 'makegrid', 后续可以再加
    'init_coil_file':                       #       str,    初始线圈文件名
            '/home/nxy/codes/coil_spline_HTS/results_b/circle/bc1_fc.npy',       
    ...
    'init_fr_file':                         #       str,    给出变量fr的初始值文件
            '/home/nxy/codes/coil_spline_HTS/results_b/circle/bc1_fr.npy',
...
# 程序输出
    ...
    'out_hdf5':                             #       str,    hdf5, 输出参数
        '/home/nxy/codes/coil_spline_HTS/results_b/circle/bcjm1_hdf5.h5',        
    'out_coil_makegrid':                    #       str,    makegrid , 输出线圈
        '/home/nxy/codes/coil_spline_HTS/results_b/circle/bcjm1_makegrid',                
    'save_loss':                            #       str,    npy, 输出损失函数值(lossvals)
        '/home/nxy/codes/coil_spline_HTS/results_b/circle/bcjm1_loss.npy',         
    'save_coil_arg':                        #       str,    npy, 输出优化线圈参数(coil_arg)
        '/home/nxy/codes/coil_spline_HTS/results_b/circle/bcjm1_coil_arg.npy',
    'save_fr':                              #       str,    npy, 输出优化旋转参数(fr)
        '/home/nxy/codes/coil_spline_HTS/results_b/circle/bcjm1_fr.npy'
