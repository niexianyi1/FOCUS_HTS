...
# 线圈
    ...
    'circle_coil_radius':       0.4,        #       float,  'circle' 的初始半径   
    'coil_file_type':           'makegrid',      #       str,    非'circle'的初始线圈文件类型, 'npy', 'hdf5' or 'makegrid', 后续可以再加
    
    # 线圈文件
    'init_coil_file':                       #       str,    初始线圈文件名
            'initfiles/hsx/coils.hsx',       
    'read_coil_segments':        384,        #       int,    makegrid文件中的线圈段数 
