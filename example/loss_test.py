...
# 线圈
    ...
    'init_coil_file':                       #       str,    初始线圈文件名
            '/home/nxy/codes/coil_spline_HTS/initfiles/w7x/w7x_coil_5.npy',       
...
# loss function 目标和权重
    ...
    'target_length':            8,          #       float,  目标长度, 
    'target_curvature_max':     1,          #       float,  目标最大曲率
    'target_torsion_max':       8,          #       float,  目标最大扭转
...
# 程序输出
    ...
    'out_hdf5':                             #       str,    hdf5, 输出参数
        '/home/nxy/codes/coil_spline_HTS/results/test_loss/cmax/hdf5.h5',        
