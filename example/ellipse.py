...
# 画图
    ...
    # 画图选项
    'plot_coil':                11,          #       int,    是否画线圈, 
            # 0:不画, 1:画线圈点集, 11:线圈和磁面, 2:画有限截面, 21:有限截面和磁面
...
# 程序输出
    ...
    'out_hdf5':                             #       str,    hdf5, 输出参数
        '/home/nxy/codes/coil_spline_HTS/results/ellipse/bnl1000/hdf5.h5',        
    'out_coil_makegrid':                    #       str,    makegrid , 输出线圈
        '/home/nxy/codes/coil_spline_HTS/results/ellipse/bnl1000/makegrid',                
    'save_loss':                            #       str,    npy, 输出损失函数值(lossvals)
        '/home/nxy/codes/coil_spline_HTS/results/ellipse/bnl1000/loss.npy',         
    'save_coil_arg':                        #       str,    npy, 输出优化线圈参数(coil_arg)
        '/home/nxy/codes/coil_spline_HTS/results/ellipse/bnl1000/coil_arg.npy',
    'save_fr':                              #       str,    npy, 输出优化旋转参数(fr)
        '/home/nxy/codes/coil_spline_HTS/results/ellipse/bnl1000/fr.npy'
