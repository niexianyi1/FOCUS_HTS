...
# 线圈
    ...
    # 有限截面参数
    'length_normal':            0.35,       # (ln)  float,  有限截面下每个线圈的法向间隔的长度                   
    'length_binormal':          0.35,       # (lb)  float,  有限截面下每个线圈的副法向间隔的长度                    
...
# 电流
    ...
    'current_I':                [1.7173544014275263994932e7],      #       list,   线圈初始电流数值         
...
# LTS/HTS材料
    ...
    'HTS_width':                0.7,      # (w)   float,  HTS材料总宽度 或 LTS材料直径
...
# 程序输出
    ...
    'save_coil_arg':                        #       str,    npy, 输出优化线圈参数(coil_arg)
        '/home/nxy/codes/coil_spline_HTS/results_f/circle/w7x_coil_arg.npy',
