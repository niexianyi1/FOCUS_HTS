...
def NbTi(temperature, Bmax, strain):
    ...
    """
    from GCEcoils.parameters import NbTi_parameters as p
...
def REBCO_Other(temperature, Bmax, strain):
    ...
    Originally authored by S B L Chislett-McDonald @ Durham University
    """
    from GCEcoils.parameters import REBCO_Other_parameters as p
...
def REBCO(temperature, Bmax, strain):
    ...
    Originally authored by S B L Chislett-McDonald @ Durham University
    """
    from GCEcoils.parameters import REBCO_parameters as p
...
def HIJC_REBCO(temperature, Bmax, strain):
    ...
    uh oh spaghettio
    """
    from GCEcoils.parameters import HIJC_REBCO_parameters as p
...
def Nb3Sn(temperature, Bmax, strain):
    from GCEcoils.parameters import Nb3Sn_parameters as p
