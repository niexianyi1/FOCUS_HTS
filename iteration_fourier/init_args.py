...
args = {
    ...
    'out_loss': '/home/nxy/codes/focusadd-spline/results_f/circle/loss_c1.npy',         
    # str, 输出损失函数值（lossvals）文件名

    'out_fc': '/home/nxy/codes/focusadd-spline/results_f/circle/fc_c1.npy',
    # str, 输出参数c文件名

    'out_fr': '/home/nxy/codes/focusadd-spline/results_f/circle/fr_c1.npy'
    # str, 输出参数fr文件名
